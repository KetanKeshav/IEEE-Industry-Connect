        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="pic"><img src="../assets/img/team/kishore.jpg" alt=""></div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="200">
              <div class="pic"><img src="../assets/img/team/Neha.jpg" alt=""></div>
              <h4>Neha Kumari</h4>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="pic"><img src="../assets/img/team/Samarth.jpg" alt=""></div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="pic"><img src="../assets/img/team/pramod.jpg" alt=""></div>
              <h4>Pramood BN</h4>
              <span>Execom Member</span>
              <div class="social">
                <a href=""><i class="bi bi-facebook"></i></a>
    ...
    <section id="team" class="team section-bg">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="pic"><img src="../assets/img/team/soumya.jpg" alt=""></div>
              <h4>Soumyadip Roy</h4>
              <span>Volunteer</span>
              <div class="social">
                <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="200">
              <div class="pic"><img src="../assets/img/team/anzar.jpg" alt=""></div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up">
              <div class="pic"><img src="../assets/img/team/subramanya.jpg" alt=""></div>
